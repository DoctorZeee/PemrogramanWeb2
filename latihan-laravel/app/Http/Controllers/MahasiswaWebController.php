...
class MahasiswaWebController extends Controller
{
    ...
    /**
     * Display the specified resource beserta daftar matakuliah dan nilainya.
     */
    ...
    /**
     * Sepuluh mahasiswa dengan IPK tertinggi pada program studi Teknik Komputer.
     */
    public function topIpk()
    {
        ...
        return view('mahasiswa.top-ipk', ['daftarMahasiswa' => $daftarMahasiswa]);
    }
